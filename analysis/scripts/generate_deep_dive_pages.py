...
IDEAS = [
    ...
    },
    {
        ...
        "cards": [
            ...
            card(2017, "culture", "Invisible work needs protection", "invisible but crucial work", "High standards protect work no customer sees directly, such as defect prevention and unseen service operations.", "The passage also connects high standards to recruiting, retention, and pride in professionalism.", "A high-standards culture makes invisible excellence worth doing.", [[201, 219]], ["invisible work", "professionalism", "retention"]),
    ...
    },
    {
        ...
        "cards": [
            ...
            card(2006, "culture", "Small seeds need protection inside a big company", "small seeds", "A new business can look tiny beside established businesses, so culture must keep it from being dismissed too early.", "Bezos says meaningful new businesses may take three to seven years before they matter to company economics.", "Without cultural protection, today's tiny idea never gets the chance to become tomorrow's engine.", [[75, 125]], ["saplings", "culture", "time horizon"]),
